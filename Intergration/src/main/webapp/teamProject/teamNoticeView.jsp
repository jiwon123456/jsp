...
<iframe src="../html/header.jsp" frameborder="0" scrolling="no"  style="margin:auto; width:100%; height:200px;"></iframe>
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>공지사항</strong><span>삼식세끼 최신 업데이트에 대한 내용을 공지합니다.</span></h2>

					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
										<p class="txt">작성자<span>소현우</span></p>
								</ul>
							</div>
							<div class="day">
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a href="teamNoticeWrite.jsp" class="sbtnMini mw">수정</a></li>
								<li><a href="teamNoticeMain.jsp" class="sbtnMini mw">목록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
