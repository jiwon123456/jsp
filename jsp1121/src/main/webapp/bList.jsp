	...
	<head>
		...
		<style>
			*{margin:0; padding:0;}
			...
			span:hover{background:#bfafdd; color:white; font-weight: 700; }
			.on{background:#bfafdd; color:white; font-weight: 700;}
			...
			<!-- 검색부분 -->	
			 <div class="wrapper">
				...
				<div id="n">
						...
						<c:if test="${page>1}">
							<a href="bList.do?page=${page-1}&bcategory=${bcategory}&bsearch=${bsearch}"><span><i class="fa fa-chevron-left" aria-hidden="true"></i></span></a>
						</c:if>
						<c:if test="${page == 1}">
						...
						<a href="bList.do?page=${page+1}&bcategory=${bcategory}&bsearch=${bsearch}"><span><i class="fa fa-chevron-right" aria-hidden="true"></i></span></a>
						</c:if>
						<c:if test="${page == maxPage}">
